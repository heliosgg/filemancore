...
bool FileManCore::Utils::Win::Time::FileTime2TimePoint(const FILETIME& ft, std::chrono::system_clock::time_point& result) {
    SYSTEMTIME st = {0};
...
bool FileManCore::Utils::Win::Time::TimePoint2FileTime(const std::chrono::system_clock::time_point& tp, FILETIME& result)
{
    using namespace std;
